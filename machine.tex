...
Keras is a minimalist, highly modular neural networks library, written in Python and capable of running on top of either TensorFlow or Theano. The model architecture for each cancer type are given in sections~(\ref{subsec:breastnn}).
...
The archictecture of the Keras multilayer perceptron neural notebook is given explicitly below:
