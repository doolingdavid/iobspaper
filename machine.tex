...
%\end{itemize}
The \code{STATE-COUNTY RECODE} variable was dropped and replaced with the \code{elevation}, \code{lat}, and \code{lng} variables as illustrated in Table~\ref{tab:nmhead}.
