...
Before applying machine learning models trained with these data sets, we review in section~(\ref{sec:surv}) the sailent features of censored data. We then describe in detail a means to take full advantage of all the data, including the right-censored data, which involves a simple and intuitive transformation, leading to the full set of features and target variables listed in sections~(\ref{subsec:colonfeatures},~\ref{subsec:lungfeatures},~\ref{subsec:breastfeatures}).
