...
In the discrete time variable case which holds for the SEER data where \codewhite{SURVIVAL MONTHS} takes on integer values, the relationship between the hazard function and the survival function is given by:
