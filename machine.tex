...
The RESPIR.txt and BREAST.txt were imported into separate dataframes in similar fashion and filtered according
to the conditions in Table~(\ref{tab:lungfilter}) and Table~(\ref{tab:breastfilter}), respectively.
%Similarly, the RESPIR.txt files were filtered according to the conditions in Table~(\ref{tab:lungfilter}),
%and the BREAST.txt files according to the those in Table~(\ref{tab:breastfilter}).
