...
Namely, when computing the AUC for the 12 month survival curve classifiers, we restrict the test data subjects in the untransformed data set that satisfy either of the following mutually exlusive conditions:
